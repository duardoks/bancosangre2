...
<form id="form1" name="form1" method="post" action="">
 ...
 <tr>
    ...
    <input type="radio" name="radioval"  value="id" />id
    <input type="radio" name="radioval"  value="nombre" />nombre
    <input type="radio" name="radioval"  value="apellido" />apellido
 ...
 if (!empty($_POST))
{
    // handle post data
                ...
                if ($_REQUEST['radioval']=="id"){

               $sql="SELECT `id_pos`, `id_usu`, `apellidopaterno_pos`, `apellidomaterno_pos`, `primernombre_pos`, `segundonombre_pos`, `sexo_pos`, `estadocivil_pos`, `dni_pos`, `fechanacimiento_pos`, `lugarnacimiento_pos`, `direccion_pos`, `distrito_pos`, `telefonofijo_pos`, `telefonomovil_pos`, `lugarprocedencia_pos`, `ocupacion_pos`, `centrolaboral_pos` FROM `bancosangre`.`postulante` where id_pos like '%$texto%';";
              
                   }
           elseif ($_REQUEST['radioval']=="nombre") {
                     $sql="SELECT `id_pos`, `id_usu`, `apellidopaterno_pos`, `apellidomaterno_pos`, `primernombre_pos`, `segundonombre_pos`, `sexo_pos`, `estadocivil_pos`, `dni_pos`, `fechanacimiento_pos`, `lugarnacimiento_pos`, `direccion_pos`, `distrito_pos`, `telefonofijo_pos`, `telefonomovil_pos`, `lugarprocedencia_pos`, `ocupacion_pos`, `centrolaboral_pos` FROM `bancosangre`.`postulante` where id like '%$texto%';";
               }
           elseif ($_REQUEST['radioval']=="apellido") {
