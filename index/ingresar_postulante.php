...
<html>
    ...
    <tr>
        <td>Apellido Paterno</td>
          ...
          <td><input type="text" name="apellidopaterno_pos" maxlength="50" pattern="^[a-zA-Z\s]*$" required/></td>
    </tr>
    
    <tr>
        <td>Apellido Materno</td>
        <td><input type="text" name="apellidomaterno_pos" maxlength="50" pattern="^[a-zA-Z\s]*$" required/></td>
    </tr>
    
    <tr>
        <td>Primer Nombre</td>
          <td><input type="text" name="primernombre_pos" maxlength="50" pattern="^[a-zA-Z\s]*$" required/></td>

    
    <tr>
        <td>Segundo Nombre</td>
            <td><input type="text" name="segundonombre_pos" maxlength="50" pattern="^[a-zA-Z\s]*$" required/></td>
    </tr>
    
    <tr>
        <td>Sexo</td>
         <td><input type="text" name="sexo_pos" maxlength="50" pattern="^[a-zA-Z\s]*$" required/></td>
    </tr>
    
     <tr>
        <td>Estado Civil</td>
         <td><input type="text" name="estadocivil_pos" maxlength="50" pattern="^[a-zA-Z\s]*$" required/></td>
    </tr>
    
     <tr>
        <td>Dni</td>
        <td><input type="text" name="dni_pos" maxlength="10" pattern="^([0-8])*$" required/></td>
    </tr>
    
    <tr>
        <td>Fecha de Nacimiento</td>
   <td><input type="datetime" name="fechanacimiento_pos" maxlength="10" pattern="^\d{4}\-\d{2}\-\d{2}$" required/></td>
    </tr>
    
    <tr>
        <td>Lugar Nacimiento</td>
          <td><input type="text" name="lugarnacimiento_pos" maxlength="50" pattern="^[a-zA-Z\s]*$" required/></td>
    </tr>
    
    <tr>
        <td>Direccion</td>
          <td><input type="text" name="direccion_pos" maxlength="50" pattern="^[a-zA-Z0-9\s]*$" required/></td>
    </tr>
        <tr>
        <td>Distrito</td>
          <td><input type="text" name="distito_pos" maxlength="50" pattern="^[a-zA-Z\s]*$" required/></td>
    </tr>
       <tr>
        <td>Telefono Fijo</td>
            <td><input type="text" name="telefonofijo_pos" maxlength="50" pattern="^[0-9\s]*$" required/></td>
    </tr>
    <tr>
        <td>Telefono Movil</td>
           <td><input type="text" name="telefonomovil_pos" maxlength="50" pattern="^[0-9\s]*$" required/></td>
    </tr>
     <tr>
        <td>Lugar Procedencia</td>
              <td><input type="text" name="lugarprocedencia_pos" maxlength="50" pattern="^[a-zA-Z\s]*$" required/></td>
    </tr>
       
         <tr>
        <td>Ocupacion</td>
              <td><input type="text" name="ocupacion_pos" maxlength="50" pattern="^[a-zA-Z\s]*$" required/></td>
    </tr>
        <tr>
        <td>CentroLaboral</td>
            <td><input type="text" name="centrolaboral_pos" maxlength="50" pattern="^[a-zA-Z0-9._\s]*$" required/></td>
    </tr>
    <tr>
